...
from utils.constants import UNLOCKED_REQUIREMENT
from config import Config
from utils.sound_manager import SoundManager
from components.popup.show_requirement_avatar_unlocked import AvatarRequirementsPopup
...
class HoverAvatar(LabeledAvatar):
    ...
    def on_avatar_press(self, instance):
        ...
        requirement_message = UNLOCKED_REQUIREMENT.get(
            self.label.text.lower(), "Persyaratan tidak ditemukan"
        )
        preview_popup = AvatarRequirementsPopup(
            avatar_source=self.normal_source,
            avatar_name=self.label.text,
